...
println peopleByCity  //This will print list of map, where key will be person.city ('New York City' & 'Cleveland') and all items that has the key
println peopleByCity.getClass().getName() //map
